...
// Dynamics
    ...
    override func viewDidLoad() {
        ...
        self.collisionBehavior.addBoundaryWithIdentifier("nfcLogo", forPath: UIBezierPath(rect: circularProgressView.frame))
...
//        let topLeftPoint = CGPointMake(origin.x, <#T##y: CGFloat##CGFloat#>)
